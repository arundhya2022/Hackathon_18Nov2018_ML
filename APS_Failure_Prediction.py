...
class APS(object):
    ...
    def trainRandomForest(self, output_folder):
        ...
        plot_confusion_matrix(cm,np.array([0,1]),output_folder,"cm_default",title="Confusion Matrix - Default Threshold")
        ...
        plot_confusion_matrix(cm_cutoff,np.array([0,1]),output_folder,"cm_custom",title="Confusion Matrix - Custom Threshold")
    ...
    def testRandomForest(self,cutoff,output_folder):
        ...
        plot_confusion_matrix(cm,np.array([0,1]),output_folder,"cm_test",title="Confusion Matrix - Threshold="+str(cutoff))
...
if __name__ == "__main__":
    ...
    Output Folder - Path where the graph and the pickled model will be available
    """
